...
import { GetInfoResponse, MeltProofOptions, MintProofOptions, MintQuoteResponse, ProofState, ReceiveOptions, RestoreOptions, SendOptions, SwapOptions, type MeltProofsResponse, type MeltQuoteResponse, type MintKeys, type MintKeyset, type Proof, type SendResponse, type Token } from './model/types/index.js';
...
declare class CashuWallet {
     ...
     * @returns the mint will create and return a melt quote for the invoice with an amount and fee reserve
     */
    createMultiPathMeltQuote(invoice: string, partialAmount: number): Promise<MeltQuoteResponse>;
    /**
