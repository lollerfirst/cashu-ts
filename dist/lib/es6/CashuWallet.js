...
import { MeltQuoteState, MintQuoteState } from './model/types/index.js';
import { bytesToNumber, getDecodedToken, getKeepAmounts, hasValidDleq, numberToHexPadded64, splitAmount, stripDleq, sumProofs } from './utils.js';
/**
...
var CashuWallet = /** @class */ (function () {
    ...
    function CashuWallet(mint, options) {
        ...
        if (options === null || options === void 0 ? void 0 : options.mintInfo)
            this._mintInfo = new MintInfo(options.mintInfo);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        keys = _c.sent();
                        if (requireDleq) {
                            if (token.proofs.some(function (p) { return !hasValidDleq(p, keys); })) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        if (!includeDleq) {
                            return [2 /*return*/, { keep: keepProofsOffline, send: stripDleq(sendProofOffline) }];
                        }
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        sendAmounts = (outputAmounts === null || outputAmounts === void 0 ? void 0 : outputAmounts.sendAmounts) || splitAmount(amountToSend, keyset.keys);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        keys = _c.sent();
                        _b = this.createBlankOutputs(sumProofs(proofsToSend) - meltQuote.amount, keys.id, counter), blindedMessages = _b.blindedMessages, secrets = _b.secrets, blindingFactors = _b.blindingFactors;
